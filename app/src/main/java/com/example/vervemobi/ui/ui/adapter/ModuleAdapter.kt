package com.example.vervemobi.ui.ui.adapter
...
class ModuleAdapter(
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val tvTitle: TextView = view.findViewById(R.id.tvTitles)
        val tvDesc: TextView = view.findViewById(R.id.tvDescs)
        val tvStatus: TextView = view.findViewById(R.id.tvStatuss)
    }
